 ...
 */
final class Version20220315143552 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personne CHANGE per_prenom per_prenom VARCHAR(38) DEFAULT NULL, CHANGE per_mail per_mail VARCHAR(50) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE profil CHANGE pro_libelle pro_libelle VARCHAR(38) NOT NULL COLLATE `utf8mb4_unicode_ci`');
