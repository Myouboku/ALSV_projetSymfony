 ...
 */
final class Version20220315082732 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE exercer (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE exercer_personne (exercer_id INT NOT NULL, personne_id INT NOT NULL, INDEX IDX_FF546C62FB4758AE (exercer_id), INDEX IDX_FF546C62A21BD112 (personne_id), PRIMARY KEY(exercer_id, personne_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE exercer_fonction (exercer_id INT NOT NULL, fonction_id INT NOT NULL, INDEX IDX_F99A7030FB4758AE (exercer_id), INDEX IDX_F99A703057889920 (fonction_id), PRIMARY KEY(exercer_id, fonction_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE exercer_personne ADD CONSTRAINT FK_FF546C62FB4758AE FOREIGN KEY (exercer_id) REFERENCES exercer (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE exercer_personne ADD CONSTRAINT FK_FF546C62A21BD112 FOREIGN KEY (personne_id) REFERENCES personne (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE exercer_fonction ADD CONSTRAINT FK_F99A7030FB4758AE FOREIGN KEY (exercer_id) REFERENCES exercer (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE exercer_fonction ADD CONSTRAINT FK_F99A703057889920 FOREIGN KEY (fonction_id) REFERENCES fonction (id) ON DELETE CASCADE');
    }
