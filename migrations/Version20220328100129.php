 ...
 */
final class Version20220328100129 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personne CHANGE per_prenom per_prenom VARCHAR(38) DEFAULT NULL, CHANGE per_mail per_mail VARCHAR(50) DEFAULT NULL, CHANGE per_tel per_tel INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur CHANGE uti_username uti_username VARCHAR(38) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE uti_mdp uti_mdp VARCHAR(38) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE uti_role uti_role VARCHAR(38) NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
