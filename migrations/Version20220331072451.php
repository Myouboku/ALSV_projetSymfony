 ...
 */
final class Version20220331072451 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE entreprise (id INT AUTO_INCREMENT NOT NULL, personne_id INT DEFAULT NULL, opt_id_id INT DEFAULT NULL, ent_rs VARCHAR(38) NOT NULL, ent_cp INT NOT NULL, ent_ville VARCHAR(50) NOT NULL, ent_adresse VARCHAR(50) NOT NULL, ent_pays VARCHAR(38) NOT NULL, INDEX IDX_D19FA60A21BD112 (personne_id), INDEX IDX_D19FA60951AEC1B (opt_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE entreprise ADD CONSTRAINT FK_D19FA60951AEC1B FOREIGN KEY (opt_id_id) REFERENCES entreprise_option (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE entreprise DROP FOREIGN KEY FK_D19FA60951AEC1B');
