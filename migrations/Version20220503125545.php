 ...
 */
final class Version20220503125545 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE personne_profil (id INT AUTO_INCREMENT NOT NULL, per_id INT NOT NULL, pro_id INT NOT NULL, annee INT NOT NULL, INDEX IDX_D2AC8A7AB304206A (per_id), INDEX IDX_D2AC8A7AC3B7E4BA (pro_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
